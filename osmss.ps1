Param(
    ...
    [string]$MalshareApiKey         = "1f6e0e583878de6dfe6bf8622cae8f50983ffd944321eceb5f42d53485433cb5",
...
Write-Host "`n==== OSMSS v1.1.0 ====" -ForegroundColor Green
$BazaarFile       = Download-MalwareData -Url $BazaarUrl -Destination $LocalBazaarFile
$MalshareFile     = Download-MalwareData -Url ("https://malshare.com/api.php?api_key=$MalshareApiKey&action=getlist") -Destination $LocalMalshareFile 
